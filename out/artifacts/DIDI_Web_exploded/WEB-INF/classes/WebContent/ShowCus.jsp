...
<div class="cart mt"><!-----------------logo------------------->
    <div class="table wrapper">
        ...
        <c:forEach var="rs" items="${requestScope.shoplist1 }">
            ...
            <div class="th">
                <div class="s"><a class="del" datasrc="${rs.name }"><a href="javascript:toorder2(${rs.id })"  style="color: #A10000"><h2>通过</h2></a></a></div>
          <%--          <div class="price"><a class="del" datasrc="${rs.name }"><a href="javascript:toorder2(${rs.id })">管理员审核</a></a></div>--%>
                <div class="s">
                    <p>
        ...
        <div class="tr clearfix"><label class="fl"><input class="checkAll" type="checkbox"/><span></span></label>
            <p class="fr"><a href="javascript:toorder2(id)" class="count">管理员审核</a></p></div>
    </div>
</div>

<script>
    function toorder2(id) {
