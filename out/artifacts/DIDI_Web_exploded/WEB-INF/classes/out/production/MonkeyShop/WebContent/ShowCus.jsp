...
<div class="cart mt"><!-----------------logo------------------->
    <div class="table wrapper">
        ...
        <c:forEach var="rs" items="${requestScope.shoplist1 }">
            ...
            <div class="th">
                <%--<div class="s"><a class="del" datasrc="${rs.name }"><a href="javascript:catedel2(${rs.id })"  style="color: #A10000"><h2>通过</h2></a></a></div>--%>
                    <div class="price"><a class="del" datasrc="${rs.name }"><a href="javascript:catedel(${rs.id })">管理员审核</a></a></div>
                <div class="s">
                    <p>
