...
<div class="head">
    <div class="wrapper clearfix">
        ...
        <ul class="clearfix" id="bott">
            ...
            <li><a href="#">IT行业</a>
                <div class="sList2">
                    <div class="clearfix"><a href="flowerDer.jsp">传统行业</a><a href="vase_proList.html">互联网行业</a></div>
                </div>
            </li>
...
<div class="banner"><a href="#"><img src="photo/休闲.jpeg"/></a></div>
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="index.html">首页</a><span>/</span><a href="flowerDer.html" class="on">传统行业</a>
    </div>
</div><!-------------------current---------------------->
<div class="current">
