       ...
       <c:forEach var="rs" items="${requestScope.shoplist }">
        ...
        <div class="th">
            <div class="pro clearfix"><label class="fl">
            	...
            	<span></span></label>
            	<a class="fl" href="selectproductview?CART_VALID=${rs.cart_valid }">
                    <div class="number">
                <dl class="clearfix">
            ...
            <div class="number">
                ...
                <div class="price">${rs.cart_u_id }</div>
            	</p>
           </div>
            <div class="number">
                <p class="num clearfix">

                    <span datasrc="${rs.cart_id }" class="fl">${rs.cart_p_stock }</span>
                </p>
            </div>
            <div class="number">
                <p class="num clearfix">

                <div class="price sAll">￥${rs.cart_p_price}.00</div>
                </p>
            </div>
            <div class="number">
                <p class="num clearfix">

                <div class="price sAll">${rs.cart_quantity}</div>
                </p>
            </div>
            ...
            <div class="number">
                ...
                <div class="price"><a class="del" datasrc="${rs.cart_id }" href="#2">审核</a></div>
                </p>
            </div>
