...
public class InFormation_USERDao {
    ...
    * */
    ...
    public static ArrayList<InFormation_USER> getCart(){
        ArrayList<InFormation_USER> list = new ArrayList<InFormation_USER>();
        //声明结果集
        ResultSet rs = null;
        //获取连接对象
        ...
        try {
            ...
            /*where CART_U_ID=? and CART_VALID=1 order by CART_ID desc"*/
            ps = conn.prepareStatement(sql);
            /*	ps.setString(1, id);*/
            rs = ps.executeQuery();

            while(rs.next()) {
                InFormation_USER c = new InFormation_USER(
                        rs.getString("id"),
                        rs.getString("name"),
                        rs.getString("phone"),
